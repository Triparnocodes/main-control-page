...
//   selectedLT,
//   toggleBreaker,
//   backendStatus,       // 🔥 NEW: reflects real fault status
//   sendControlCommand,  // 🔥 NEW: function to call backend /api/control
// }) {
//   if (!selectedLT) return null;

//   // 🧠 Auto-toggle breaker if backend says real trip happened
//   useEffect(() => {
//     if (!selectedLT) return;

//     if (backendStatus === "CRITICAL" || backendStatus === "MANUAL_TRIP") {
//       // Trip only if still ON
//       selectedLT.breakers.forEach((b, index) => {
//         if (b.status === "ON") {
//           toggleBreaker(selectedLT.id, index);  // Update UI
//         }
//       });
//     }

//     if (backendStatus === "STABLE" && selectedLT) {
//       // Auto-reset UI switches only if OFF
//       selectedLT.breakers.forEach((b, index) => {
//         if (b.status === "OFF") {
//           toggleBreaker(selectedLT.id, index);
//         }
//       });
//     }
//   }, [backendStatus]);
...
//                 <div
//                   onClick={() => {
//                     const action = b.status === "ON" ? "TRIP" : "RESET";
//                     sendControlCommand(action); // 🔥 send to backend
//                     toggleBreaker(selectedLT.id, i); // update UI
//                   }}
//                   style={{
//                     width: "40px",
//                     height: "22px",
